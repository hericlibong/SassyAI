...
- [x] T010 [P] Implement environment-based runtime settings in `backend/src/config/settings.py`
- [x] T011 [P] Implement in-memory session repository for active conversations in `backend/src/chat/session_store.py`
...
- [x] T018 [P] [US1] Add persona policy unit test for low/medium/high behavior in `backend/tests/unit/test_persona_policy.py`
...
- [x] T024 [US1] Wire frontend bootstrap and layout assets in `frontend/src/app/main.js`, `frontend/src/index.html`, and `frontend/src/styles.css`
...
- [x] T026 [P] [US2] Add fallback API integration test in `backend/tests/integration/test_chat_fallback.py`

### Implementation for User Story 2

- [x] T027 [P] [US2] Implement primary provider adapter with timeout handling in `backend/src/llm/openai_provider.py`
- [x] T028 [US2] Extend runtime provider selection and timeout configuration in `backend/src/config/settings.py`
- [x] T029 [US2] Apply fallback classification and retry-safe session behavior in `backend/src/chat/service.py`
- [x] T030 [US2] Render fallback state messaging in `frontend/src/chat/chat-app.js`
...
- [x] T032 [P] [US3] Add safety refusal integration test in `backend/tests/integration/test_chat_safety.py`
